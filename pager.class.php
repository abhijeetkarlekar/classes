	...
	***********************************************************************************/
	...
	public function pageNumNextPrevUrl($curpage, $pages, $siteurl="", $param = ""){
		...
		if (($curpage-1) <= 0){
			...
			$next_prev .="<li><a href=\"".$siteurl."page/".($curpage-1).$param."\" title=\"Previous\" rel=\"prev\"><i class=\"pags-fl\"></i>" . $prev_link . "</a></li>";
		}
		/* Print the numeric page list; make the current page unlinked and bold */
		if($curpage+4 < $pages)
		$pk=$curpage+4;
		...
		if (($curpage+1) <= $pages){
			if(($curpage < $pages) && ($pages > 1)){
				//$next_prev .= "<li><a class=\"pagearrow pagenext\" >".$next_link." </a> </li>";
				$next_prev .= "<li><a href=\"".$siteurl."page/".($curpage+1).$param."\" title=\"Next\" rel=\"next\"><i class=\"pags-fr\"></i>".$next_link." </a> </li>";
			}
		}else{
			if($pages > 1){
				//$next_prev .=  "<li><a href=\"".$siteurl."/".($curpage+1).$param."\" title=\"Next\"  class=\"pagearrow pnext-unActive\">" . $next_link . "</a> </li>";
